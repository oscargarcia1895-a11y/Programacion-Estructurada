...
void Guardar_Tablero(FILE *f, int Tablero[5][5], char nombre[])
{
    fprintf(f, "\nTablero de %s\n", nombre);
...
void Juego(int Tablero_1[5][5], int Tablero_2[5][5]) {
    ...
    while (game) {
        ...
        fprintf(f, "Jugador 1: %s\n", jugador1);
        fprintf(f, "Jugador 2: %s\n", jugador2);

        Guardar_Tablero(f, Tablero_1, jugador1);
        Guardar_Tablero(f, Tablero_2, jugador2);
